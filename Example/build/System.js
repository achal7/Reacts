...
/***/ function(module, exports, __webpack_require__) {
	...
	var Shell = _babelHelpers.interopRequire(__webpack_require__(1));

	var Bootstrap = {
	    Boot: function Boot() {
	        var ctx = { Name: "root" };
	        React.render(React.createElement(Shell, { Context: ctx }), document.body);
	    }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RNext = _babelHelpers.interopRequire(__webpack_require__(4));

	var Header = _babelHelpers.interopRequire(__webpack_require__(5));

	var Footer = _babelHelpers.interopRequire(__webpack_require__(6));

	var Home = _babelHelpers.interopRequire(__webpack_require__(7));

	var con = { Name: "home context", name: "home ctx" };

	var Shell = (function (_RNext$Component) {
	    function Shell() {
	        _babelHelpers.classCallCheck(this, Shell);

	        if (_RNext$Component != null) {
	            _RNext$Component.apply(this, arguments);
	        }
	    }

	    _babelHelpers.inherits(Shell, _RNext$Component);

	    _babelHelpers.prototypeProperties(Shell, null, {
	        render: {
	            value: function render() {
	                return React.createElement(
	                    ...
	                    React.createElement(Home, { context: con, Name: "Home page" }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _core = __webpack_require__(8)["default"];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Reacts = _babelHelpers.interopRequire(__webpack_require__(4));

	var Header = (function (_Reacts$Component) {
	    function Header() {
	        _babelHelpers.classCallCheck(this, Header);

	        if (_Reacts$Component != null) {
	            _Reacts$Component.apply(this, arguments);
	        }
	    }

	    _babelHelpers.inherits(Header, _Reacts$Component);

	    _babelHelpers.prototypeProperties(Header, null, {
	        render: {
	            value: function render() {
	                return React.createElement(
	                    "div",
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Footer = (function (_Reacts$Component) {
	    function Footer() {
	        _babelHelpers.classCallCheck(this, Footer);
	    ...
	    _babelHelpers.inherits(Footer, _Reacts$Component);

	    _babelHelpers.prototypeProperties(Footer, null, {
	        render: {
	            value: function render() {
	                return React.createElement(
	                    "div",
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LogMixin = _babelHelpers.interopRequire(__webpack_require__(11));

	var CoreMixin = {
	    componentWillMount: function componentWillMount(context) {
	        console.log("Core: Initialization done in core" + context.Name);
	    }
	};

	var Home = (function (_Reacts$ComponentWithMixin) {
	    function Home(context) {
	        _babelHelpers.classCallCheck(this, Home);

	        _babelHelpers.get(_core.Object.getPrototypeOf(Home.prototype), "constructor", this).call(this, context, Home);
	    }

	    _babelHelpers.inherits(Home, _Reacts$ComponentWithMixin);

	    _babelHelpers.prototypeProperties(Home, {
	        PreRender: {
	            value: function PreRender(context) {
	    ...
	    return Home;
	})(Reacts.ComponentWithMixin(null, CoreMixin, LogMixin));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EventsExecutor = _babelHelpers.interopRequire(__webpack_require__(34));

	var EventToExecutor = _babelHelpers.interopRequire(__webpack_require__(35));

	var _ReactComponentJsx = __webpack_require__(36);

	var ReactComponent = _ReactComponentJsx.ReactComponent;
	var ComponentMixin = _ReactComponentJsx.ComponentMixin;

	var ComponentExtensions = _babelHelpers.interopRequire(__webpack_require__(37));

	var ReactNext = {
	    ReactComponent: ReactComponent,
	    ComponentWithMixin: function (com) {
	        for (var _len = arguments.length, mixins = Array(_len > 1 ? _len - 1 : 0), _key = 1; _key < _len; _key++) {
	            mixins[_key - 1] = arguments[_key];
	        }

	        com = com || ReactComponent;return ComponentExtensions.Extends.apply(ComponentExtensions, [com].concat(mixins));
	    },
	    Component: function (com) {
	        com = com || ReactComponent;return ComponentExtensions.Extends(com);
	    },
	    //Component: (com, ...mixins) => { com = com || ReactComponent; return Extends(com, ...mixins); },
	    ComponentMixin: ComponentMixin
	};
	module.exports = ReactNext;
	/**
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LogMixin = (function (_Reacts$ComponentMixin) {
	    function LogMixin() {
	        _babelHelpers.classCallCheck(this, LogMixin);

	        if (_Reacts$ComponentMixin != null) {
	            _Reacts$ComponentMixin.apply(this, arguments);
	        }
	    }

	    _babelHelpers.inherits(LogMixin, _Reacts$ComponentMixin);

	    _babelHelpers.prototypeProperties(LogMixin, {
	        PreRender: {
	            value: function PreRender(context) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactEventExecutor = (function () {
	    function ReactEventExecutor() {
	        _babelHelpers.classCallCheck(this, ReactEventExecutor);
	    }

	    _babelHelpers.prototypeProperties(ReactEventExecutor, {
	        ManyExecute: {
	            value: function ManyExecute(events, context) {
	        ...
	        MergeExecute: {
	            value: function MergeExecute(events, context) {
	                events.map(function (e) {
	                    return e(context);
	                });
	            },
	        ...
	        Single: {
	            value: function Single(events, context) {
	    ...
	    return ReactEventExecutor;
	})();

	module.exports = ReactEventExecutor;
	/**
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Executor = _babelHelpers.interopRequire(__webpack_require__(34));

	var BehaviourToExecutor = exports.BehaviourToExecutor = undefined;
	BehaviourToExecutor = exports.BehaviourToExecutor = {
	    Many: Executor.ManyExecute,
	    Merge: Executor.ManyExecute,
	    Single: Executor.Single
	};

	var ReactEventToBehaviour = exports.ReactEventToBehaviour = undefined;
	ReactEventToBehaviour = exports.ReactEventToBehaviour = {
	...
	var ComponentEvents = exports.ComponentEvents = function ComponentEvents() {
	    _babelHelpers.classCallCheck(this, ComponentEvents);
	...
	var EventNamesAdapater = exports.EventNamesAdapater = (function () {
	    function EventNamesAdapater() {
	        _babelHelpers.classCallCheck(this, EventNamesAdapater);
	    }

	    _babelHelpers.prototypeProperties(EventNamesAdapater, {
	        GetReactNextEventName: {
	            value: function GetReactNextEventName(event) {
	        ...
	        GetReactEventName: {
	            value: function GetReactEventName(event) {
	                if (event === "Initialize") {
	    ...
	    return EventNamesAdapater;
	})();

	var ReactClassInterface = exports.ReactClassInterface = undefined;
	ReactClassInterface = exports.ReactClassInterface = ["componentWillMount"];

	var ReactEventFilter = exports.ReactEventFilter = (function () {
	    function ReactEventFilter() {
	        _babelHelpers.classCallCheck(this, ReactEventFilter);
	    }

	    _babelHelpers.prototypeProperties(ReactEventFilter, {
	        Single: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactComponent = exports.ReactComponent = (function (_React$Component) {
	    function ReactComponent(context, events) {
	        _babelHelpers.classCallCheck(this, ReactComponent);

	        this.events = events;
	        this.context = context || {};
	    }

	    _babelHelpers.inherits(ReactComponent, _React$Component);

	    _babelHelpers.prototypeProperties(ReactComponent, null, {
	        render: {
	            value: function render() {
	...
	var ComponentMixin = exports.ComponentMixin = function ComponentMixin() {
	    _babelHelpers.classCallCheck(this, ComponentMixin);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactEvents = _babelHelpers.interopRequireWildcard(__webpack_require__(35));

	//{-, ReactEventFilter, EventNamesAdapater, ReactEvents, ReactEventToBehaviour}

	var ComponentExtensions = (function () {
	    function ComponentExtensions() {
	        _babelHelpers.classCallCheck(this, ComponentExtensions);
	    }

	    _babelHelpers.prototypeProperties(ComponentExtensions, {
	        Extends: {
	            value: function Extends(Parent) {
	                for (var _len = arguments.length, mixins = Array(_len > 1 ? _len - 1 : 0), _key = 1; _key < _len; _key++) {
	                    mixins[_key - 1] = arguments[_key];
	                }
	                ...
	                mixins = mixins || [];
	                mixins.push(Parent);
	                var events = ComponentExtensions.GetEvents(mixins, ReactEvents.ReactEventFilter.ExcludeSingle());

	                var Mixed = (function (Parent) {
	                    function Mixed(context, component) {
	                        _babelHelpers.classCallCheck(this, Mixed);

	                        ComponentExtensions.MergeEvents(events, component);
	                        _babelHelpers.get(_core.Object.getPrototypeOf(Mixed.prototype), "constructor", this).call(this, context, events);
	                        var revents = ReactEvents.ReactClassInterface;
	                        for (var revent in revents) {
	                            for (var _event in events) {
	                                var _ret = (function (_event) {
	                                    if (events[_event].length > 0 && ReactEvents.EventNamesAdapater.GetReactEventName(_event) == revents[revent]) {
	                                        Mixed.prototype[revents[revent]] = function () {
	                                            return ReactEvents.ReactEventToBehaviour[_event](events[_event], context);
	                                        };
	                                        return "break";
	                                    }
	                                })(_event);
	                    ...
	                    _babelHelpers.inherits(Mixed, Parent);
	        ...
	        GetEvents: {
	            value: function GetEvents(mixins, filter, events) {
	                filter = filter || ReactEvents.ReactEventFilter.All();
	                var isArray = Object.prototype.toString.call(mixins) === "[object Array]";
	                var arrMixins = [];
	                if (!isArray) {
	                ...
	                var events = events || new ReactEvents.ComponentEvents();
	                var _iteratorNormalCompletion = true;
	                var _didIteratorError = false;
	                var _iteratorError = undefined;

	                try {
	                    for (var _iterator = _core.$for.getIterator(arrMixins), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	                        var mixin = _step.value;

	                        if (!mixin) {
	                            if (_iterator["return"]) _iterator["return"]();
	                            break;
	                        }var isModern = mixin.isModern || false;
	                        var props = _core.Object.keys(mixin);
	                        if (typeof mixin === "function") {
	                            props = _core.Object.getOwnPropertyNames(mixin);
	                        }
	                        ...
	                        try {
	                            for (var _iterator2 = _core.$for.getIterator(props), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
	                                var prop = _step2.value;

	                                var property = isModern ? prop : ReactEvents.EventNamesAdapater.GetReactNextEventName(prop);
	        ...
	        MergeEvents: {
	            value: function MergeEvents(target) {
	                for (var _len = arguments.length, sources = Array(_len > 1 ? _len - 1 : 0), _key = 1; _key < _len; _key++) {
	                    sources[_key - 1] = arguments[_key];
	                }

	                var events = ComponentExtensions.GetEvents(sources);
	                for (var _event in events) {
	                    (function (_event) {
	                        if (target[_event]) {
	                            events[_event].map(function (e) {
	                                return target[_event].push(e);
	                            });
